function pozymiai = pozymiai_atpazinti(pavadinimas, pvz_eiluciu_sk,show)
...
if show == 1 
    disp("Skaicius " + Skaicius)
    disp("Raidziu skaicius " + raidziu_sk)
    disp("Eiluciu skaicius " + pvz_eiluciu_sk)
end
...
if show == 1
figure(5),
% imshow(objektai{Skaicius})

raidziu_sk = round(raidziu_sk,0);
